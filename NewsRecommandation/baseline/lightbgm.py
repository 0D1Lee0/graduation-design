...
import const
from baseline import error_analysis, process_data
from baseline.error_analysis import getTestDict
from itemcf import submit
import measurement
...
if __name__ == '__main__':
    ...
    lgb_ranker = lgb.LGBMRanker(boosting_type='gbdt', num_leaves=31, reg_alpha=0.0, reg_lambda=1,
                                max_depth=5, n_estimators=200, subsample=0.8, colsample_bytree=0.7, subsample_freq=1,
    ...
    save_name = submit(rank_results, topk=5, model_name='lgb_ranker')
    ...
    #recall_dict = measurement.recall2dict(item_recall_path)
    #rr_recall_dict = measurement.recall2dict(rr_item_recall_path)
    test_df = pd.read_csv(test_path)
    ...
    r1, p1, f1 = measurement.recall_precision_f(predicted_dict, test_dict)
